		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday6exercise1delacruz-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exercise1delacruz-display": {
								"semanticObject": "zbtpday6exercise1delacruz",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exercise1delacruz",
									"url": sap.ui.require.toUrl("zbtp/day6exercise1delacruz")
								}
							}
						}
					}
